...
<div class="flex flex-col mx-4">
    <div class="card p-3 flex flex-col mt-6 w-full lg:w-1/2 self-center items-center">
        <svg version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="stroke-current w-1/3 text-jean"
        ...
        <a href="{{ route('index') }}" class="p-2 bg-gray-300 hover:bg-gray-400 text-gray-600 mt-4 rounded flex ">
