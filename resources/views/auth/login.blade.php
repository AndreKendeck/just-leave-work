...
<div class="flex flex-col items-center h-screen mx-4">
     <svg id="Background_Object_Table_2" data-name="Background Object / Table / 2" xmlns="http://www.w3.org/2000/svg"
          width="194" height="147" viewBox="0 0 194 147">
          <g id="Group_36" data-name="Group 36" transform="translate(34.899 20.234)">
               ...
               <path id="Stroke_2" data-name="Stroke 2" d="M19.888,0,0,11.375" transform="translate(23.894 0.545)"
                    fill="none" stroke="#cce3ff" stroke-miterlimit="10" stroke-width="12" />
               <path id="Stroke_4" data-name="Stroke 4" d="M0,.5H8.112" transform="translate(43.551 0.291)" fill="none"
                    stroke="#cce3ff" stroke-miterlimit="10" stroke-width="12" />
               ...
               <path id="Fill_16" data-name="Fill 16" d="M27.349,0l-5,16.5H0L5,0Z" transform="translate(72.833 14.022)"
                    fill="#fff" />
