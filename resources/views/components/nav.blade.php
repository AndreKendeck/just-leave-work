...
<div x-data="{ showNotifications : false }"  x-on:click.away="showNotifications = false">
     <div
          ...
          <div class="flex justify-between md:justify-around items-center text-gray-700">
               ...
               <a href="{{ route('profile') }}" class="md:flex px-2 mx-2 rounded-lg">
                    <img src="{{ Auth::user()->avatar_url }}" class="w-8 h-8 rounded-full mx-3" alt="avatar">
               </a>

               <form action="{{ route('logout') }}" method="POST" class="mx-2">
                    @csrf
                    <button class="bg-red-600 p-2 text-red text-sm hover:bg-red-800" type="submit">
                         <svg version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                              class="stroke-current text-white w-3 h-3" xmlns:xlink="http://www.w3.org/1999/xlink">
                              <g fill="none">
