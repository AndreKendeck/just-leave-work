...
<div class="flex justify-between items-center w-screen px-4 py-8 md:py-4 md:bg-white ">
     ...
     <div class="flex justify-around items-center text-gray-700">
          ...
          <a href="{{ route('index') }}" class="hidden md:flex mx-4 hover:bg-gray-500 px-2 py-1 rounded-lg">
               Home
          </a>

          <a href="{{ route('leaves.index') }}" class="hidden md:flex mx-4 hover:bg-gray-500 px-2 py-1 rounded-lg">
               Leaves
          </a>

          <a href="{{ route('users.index') }}" class="hidden md:flex mx-4 hover:bg-gray-500 px-2 py-1 rounded-lg">
               Users
          </a>

          <div class="relative flex md:mx-4 md:hover:bg-gray-500 md:p-1 md:rounded-lg">
               <a href="{{ route('notifications.index') }}">
                    <svg id="Bell_Notification" data-name="Bell, Notification"
                         class="stroke-current stroke-0 w-8 h-8 text-gray-800 md:text-gray-700" xmlns="http://www.w3.org/2000/svg"
