...
<div class="flex flex-col md:flex-row h-screen w-full mx-2 justify-around items-center">
     <div class="lg:flex lg:items-center">
          <div class="flex w-full justify-center">
              {!! file_get_contents(asset('images/svg/travellers.svg')) !!}
          </div>
          <div class="w-full lg:flex lg:flex-col">
               ...
               <div class="mt-10 flex flex-col justify-between ">
                    <a href="{{ route('register') }}"
                         class="py-3 px-2 text-white bg-jean rounded-lg flex justify-between w-1/2 self-center ">
                    ...
                    hover:bg-gray-900 w-1/2 self-center">
