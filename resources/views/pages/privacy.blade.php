...
<div class="flex flex-col mx-4">
     <div class="mt-6 flex flex-col p-3">
          ...
          <p>Welcome to <b> JustLeave</b>.</p>
          <p><b>JustLeave</b> (“us”, “we”, or “our”) operates <b>justleave.work</b> (hereinafter referred to as
               <b>“Service”</b>).</p>
          <p>Our Privacy Policy governs your visit to <b>justleave.work</b>, and explains how we collect, safeguard and
          ...
          <p><b>SERVICE</b> means the justleave.work website operated by JustLeave.</p>
          ...
          <p>While using our Service, we may also collect the following information: sex, age, date of birth, place of
               ...
               employment agreements, non-disclosure agreements, information on bonuses and compensation, information on
               marital status, family members, social security (or other taxpayer identification) number, office
               location and other data.</p>
          <p>5. <b>Use of Data</b></p>
          <p>JustLeave uses the collected data for various purposes:</p>
          ...
          <p>If you are located outside South Africa and choose to provide information to us, please note that we
               transfer the data, including Personal Data, to South Africa and process it there.</p>
          ...
          <p>JustLeave will take all the steps reasonably necessary to ensure that your data is treated securely and in
          ...
          <p>Under certain circumstances, we may be required to disclose your Personal Data if required to do so by law
               or in response to valid requests by public authorities.</p>
          ...
          <p>We may employ third party companies and individuals to facilitate our Service (<b>“Service Providers”</b>),
               provide Service on our behalf, perform Service-related services or assist us in analysing how our Service
               is used.</p>
          ...
          <p>We may use remarketing services to advertise on third party websites to you after you visited our Service.
               We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to
               our Service.</p>
          ...
          <p>For example, the outlined Privacy Policy has been created using <a
                    href="https://policymaker.io/">PolicyMaker.io</a>, a free web application for generating
               high-quality legal documents. PolicyMaker’s online free privacy policy generator is an easy-to-use tool
               for creating <a href="https://policymaker.io/privacy-policy/">privacy policy</a> template for a website,
               blog, online store or app.</p>
