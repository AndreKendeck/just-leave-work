...
<div class="h-screen mx-3 lg:mx-6 flex flex-col lg:flex-row mb-6" id="home">
     ...
     <div class="card flex flex-col mt-10 p-4 md:w-full lg:w-8/12 self-center lg:self-auto shadow-xs">
          <div class="flex flex-col md:flex-row mt-3 justify-between items-center">
               ...
               <div class="flex justify-between mt-3 md:mt-0">
                    ...
                    <a class="bg-gray-800 hover:bg-gray-600 text-white p-3 text-center rounded-lg"
                         href="{{ route('leaves.create') }}"> Request leave </a>
               </div>
          </div>
          <hr class="my-6" />
     ...
     <div class="flex flex-col lg:w-4/12 mx-3 ">
...
@endsection
@section('script')
<script src="{{ asset('js/leave-card.js') }}"></script>
<script>
     new Vue({
          el : '#home', 
          data : {
