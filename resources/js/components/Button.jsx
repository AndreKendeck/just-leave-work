...
const Button = (props) => {
    switch (props.type) {
        case 'secondary':
            return <button onClick={props.onClick} className="focus:outline-none bg-purple-500 text-white p-2 w-full rounded text-center hover:bg-purple-400" >{props.children}</button>
        case 'outlined':
        ...
        default:
            return <button onClick={props.onClick} className="focus:outline-none bg-gray-800 text-white p-2 w-full rounded text-center hover:bg-gray-700" >{props.children}</button>
    }
}
