...
const Button = (props) => {
    switch (props.type) {
        ...
        case 'outlined':
            return <button onClick={props.onClick} disabled={props.disabled} className="items-center text-gray-800 border-2 border-gray-800 p-2 w-full rounded text-center hover:bg-gray-800 hover:text-white tranform" >{props.children}</button>
        case 'soft':
        ...
        default:
            return <button onClick={props.onClick} disabled={props.disabled} className="items-center focus:outline-none bg-gray-800 text-white p-2 w-full  rounded text-center hover:bg-gray-700 tranform">{props.children}</button>
    }
}
