...
const Field = (props) => {
    ...
    return (
        <div className="flex flex-col space-y-1">
            ...
            <input type={props.type ? props.type : 'text '} onChange={props.onChange} onKeyUp={props.onKeyUp} id={props.name} name={props.name} className="form-input border-2 border-gray-300 rounded-lg" />
            <div className="flex flex-col space-y-1">
                {getErrors()}
            </div>
        </div>
