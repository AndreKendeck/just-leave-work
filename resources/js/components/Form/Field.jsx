...
const Field = ({ name, label, errors = [], tip, onKeyUp, onChange, hasError = false, readOnly = false, type = 'text', placeHolder, value, disabled = false, ...rest }) => {
    ...
    return (
        <div className="flex flex-col space-y-1 w-full">
            ...
            <input type={type} {...rest} readOnly={readOnly} disabled={disabled} value={value} placeholder={placeHolder} onChange={onChange} onKeyUp={onKeyUp} id={name} name={name}
