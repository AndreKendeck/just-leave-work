...
const LeaveStatusBadge = ({ leave }) => {
    if (leave?.approved) {
        return (
            <span className="bg-green-300 rounded-full text-green-600 px-2 flex space-x-1 items-center bg-opacity-25 py-1 justify-center">
                <span>
    ...
    if (leave?.denied) {
        return (
            <span className="bg-red-300 rounded-full text-red-800 px-2 flex space-x-1 items-center bg-opacity-25 py-1 justify-center">
                <span>
    ...
    return (
        <span className="text-xs bg-yellow-300 rounded-full text-yellow-600 px-2 flex space-x-1 items-center bg-opacity-25 py-1 justify-center">
            <span>
